...
/**
 * An interface that indicates that a given Editor is composed of an unknown number of sub-Editors
 * all of the same type.
 *
 * <p>For example, the {@link org.gwtproject.editor.client.adapters.ListEditor ListEditor} type is a
 * <code>CompositeEditor&lt;List&lt;T&gt;, T, E extends Editor&lt;T&gt;&gt;</code>; that is,
 * ListEditor will accept a List&lt;T&gt; and will edit some unknown number of <code>T</code>'s
 * using the Editor type <code>E</code>. Another example might be:
 *
 * <pre>
...
public interface CompositeEditor<T, C, E extends Editor<? super C>> extends ValueAwareEditor<T> {
   ...
   * @see org.gwtproject.editor.client.testing.MockEditorChain
   */
  public interface EditorChain<C, E extends Editor<? super C>> {
    /**
     * Editors attached to the chain will be automatically flushed as if they were a
     * statically-defined sub-Editor.
     *
  ...
  /**
   * Returns an canonical sub-editor instance that will be used by the driver for computing all
   * edited paths.
   *
  ...
  /**
   * Used to implement {@link EditorDelegate#getPath()} for the component Editors.
   *
   * @param subEditor an instance of the Editor type previously passed into {@link
   *     EditorChain#attach}
