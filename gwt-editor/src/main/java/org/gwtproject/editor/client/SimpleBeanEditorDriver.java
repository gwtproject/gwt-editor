 ...
 * </pre>
 *
 * <p>Note that this interface is intended to be implemented by generated code and is subject to API
 * expansion in the future.
 *
 * @param <T> the type being edited
 * @param <E> the Editor for the type
 * @see org.gwtproject.editor.client.testing.MockSimpleBeanEditorDriver
 */
