...
public interface ValueAwareEditor<T> extends HasEditorDelegate<T> {
  /**
   * Indicates that the Editor cycle is finished. This method will be called in a depth-first order
   * by the EditorDriver, so Editors do not generally need to flush their sub-editors.
   */
  void flush();

  /**
   * Notifies the Editor that one or more value properties have changed. Not all backing services
   * support property-based notifications.
   *
   ...
   *
   * <p>ValueAwareEditors should preferentially use sub-editors to alter the properties of the
   * object being edited.
   *
