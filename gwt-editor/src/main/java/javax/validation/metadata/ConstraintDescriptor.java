...
/**
 * Describes a single constraint and its composing constraints. <code>T</code> is the constraint's
 * annotation type.
 *
...
public interface ConstraintDescriptor<T extends Annotation> {
   ...
   * only the <code>Default</code> group is returned.
   *
   ...
   * values as value. If this constraint is used as part of a composed constraint, attribute values
   * are reflecting the overridden attribute of the composing constraint.
   *
