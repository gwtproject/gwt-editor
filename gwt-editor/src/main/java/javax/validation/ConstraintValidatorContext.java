 ...
 *
 * <p>At least one <code>ConstraintViolation</code> must be defined (either the default one, of if
 * the default <code>ConstraintViolation</code> is disabled, a custom one).
 *
 * @author Emmanuel Bernard
 */
public interface ConstraintValidatorContext {
  /**
   * Disable the default <code>ConstraintViolation</code> object generation (which is using the
   * message template declared on the constraint). Useful to set a different violation message or
   * generate a <code>ConstraintViolation</Code> based on a different property.
   */
  ...
  /**
   * <code>ConstraintViolation</code> builder allowing to optionally associate the violation report
   * to a sub path.
   *
   * <p>To create the <code>ConstraintViolation</code>, one must call either one of the
   * #addConstraintViolation() methods available in one of the interfaces of the fluent API. If
   * another method is called after #addConstraintViolation() on <code>ConstraintViolationBuilder
   * </code> or any of its associated objects an <code>IllegalStateException</code> is raised.
   */
  interface ConstraintViolationBuilder {
    /**
     * Add a node to the path the <code>ConstraintViolation</code> will be associated to. <code>name
     * </code> describes a single property. In particular, dot (.) is not allowed.
     *
    ...
    /**
     * Add the new <code>ConstraintViolation</code> to be generated if the constraint validator
     * marks the value as invalid. Methods of this <code>ConstraintViolationBuilder</code> instance
     * and its nested objects return <code>IllegalStateException</code> from now on.
     *
     * @return the <code>ConstraintValidatorContext</code> instance the <code>
     *     ConstraintViolationBuilder</code> comes from
     */
    ...
    interface NodeBuilderDefinedContext {
      ...
      /**
       * Add a node to the path the <code>ConstraintViolation</code> will be associated to. <code>
       * name</code> describes a single property. In particular, dot (.) are not allowed.
       *
      ...
      /**
       * Add the new <code>ConstraintViolation</code> to be generated if the constraint validator
       * marks the value as invalid. Methods of the <code>ConstraintViolationBuilder</code> instance
       * this object comes from and the constraint violation builder nested objects return <code>
       * IllegalStateException</code> after this call.
       *
       * @return <code>ConstraintValidatorContext</code> instance the <code>
       *     ConstraintViolationBuilder</code> comes from
       */
      ConstraintValidatorContext addConstraintViolation();
    }
    ...
    interface NodeBuilderCustomizableContext {
      ...
      /**
       * Add the new <code>ConstraintViolation</code> to be generated if the constraint validator
       * mark the value as invalid. Methods of the <code>ConstraintViolationBuilder</code> instance
       * this object comes from and the constraint violation builder nested objects return <code>
       * IllegalStateException</code> after this call.
       *
       * @return <code>ConstraintValidatorContext</code> instance the <code>
    ...
    interface NodeContextBuilder {
      ...
      /**
       * Add a node to the path the <code>ConstraintViolation</code> will be associated to. <code>
       * name</code> describes a single property. In particular, dot (.) is not allowed.
       *
       * @param name property <code>name</code>
       * @return a builder representing this node
       */
