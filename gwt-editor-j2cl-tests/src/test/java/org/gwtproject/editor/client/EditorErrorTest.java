...
// @J2clTestInput(EditorErrorTest.class)
public class EditorErrorTest {
  ...
  @IsDriver
  interface WorkgroupNestedErrorsEditorDriver
      extends SimpleBeanEditorDriver<Workgroup, WorkgroupNestedErrorsEditor> {}
  ...
  public void testListOfErrors() {
    ...
    WorkgroupEditorDriver driver = new EditorErrorTest_WorkgroupEditorDriver_Impl();
    ...
    assertEquals(
        Arrays.asList("people[0].address", "people[1].address"),
  ...
  public void testNestedErrors() {
    ...
    WorkgroupNestedErrorsEditorDriver driver =
        new EditorErrorTest_WorkgroupNestedErrorsEditorDriver_Impl();
   ...
   *
   * <p>The external bug report: http://code.google.com/p/google-web-toolkit/issues/detail?id=5589
   */
  @Test
