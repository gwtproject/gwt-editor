...
public class TestEditor05_phone_Context extends AbstractEditorContext<String> {
  private final Model01Dto parent;
  
  public TestEditor05_phone_Context(Model01Dto parent, Editor<String> editor, String path) {
    super(editor, path);
    this.parent = parent;
  }
